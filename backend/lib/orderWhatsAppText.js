...
function itemBreakdownLines(items) {
...
function buildReviewToken(orderId, customerId) {
  return Buffer.from(`${orderId}-${customerId}-rosanah`).toString('base64');
}
